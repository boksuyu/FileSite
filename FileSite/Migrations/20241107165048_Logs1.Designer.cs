...
namespace FileSite.Migrations
{
    ...
    [Migration("20241107165048_Logs1")]
    partial class Logs1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FileSite.Models.AppUser", b =>
                {
            ...
            modelBuilder.Entity("FileSite.Models.FileData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FileSite.Models.FileData", b =>
                {
                    b.HasOne("FileSite.Models.AppUser", "Owner")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("FileSite.Models.Logs.FileActionLogs", b =>
                {
                    b.HasOne("FileSite.Models.Logs.FileActionLogs", "ActionType")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FileSite.Models.AppUser", null)
                        .WithMany()
